<template>
    <div class="flex-flex-col rounded-lg bg-[#214BF6] p-2">
        <div class="inner relative rounded-lg">
            <div class="absolute left-2  lg:left-3  top-2 lg:top-3 rounded-full bg-[#ffffff46] p-3">
                <IconsRocketIcon class="w-6 h-6" colour="white"/>
            </div>
        </div>
