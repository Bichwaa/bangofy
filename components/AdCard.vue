<template>
        ...
        <div class="border border-slate-200 rounded-lg hover:shadow-lg hover:shadow- hover:shadow-grey duration-300 ">
            <div class="inner relative rounded-lg" >
                <div class="text-xs font-medium absolute left-2 top-2 pill rounded-3xl bg-[#F3DF00] px-4 py-2" v-if="isSponsored">sponsored</div>
            ...
            <div class="flex flex-col p-2 my-2">
                <span class="title text-sm font-medium pl-1 cursor-pointer my-2" @click="openDetails">Name and model</span>
                <span class="font-semibold pl-1">
                    TZS 250,000,000
                </span>
            </div>

            <div class="flex flex-col-reverse md:flex-row md:justify-between p-2 my-4">
